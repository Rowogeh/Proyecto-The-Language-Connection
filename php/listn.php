...
if (isset($_GET['page_no']) && $_GET['page_no']!="") {
	...
	$result_count = mysqli_query($bd,"SELECT COUNT(*) As total_records FROM `notas`");
...
/*------------------------------------------------------------------------------------------------*/
	...
	$query = "select * from notas limit $offset, $total_records_per_page";
...
<!----------------------------------------------------------------------------------------------->
	...
	<?php if($res->num_rows) : ?>
		...
		<div class="container content-section top2">
			...
			<div class="col-md-12 order-md-1">
				...
				<div class="text-center">
					...
					<button id="form4" class="green"><i class="fa fa-paper-plane"></i> Formulario</button>
				</div>
		...
		<table class="table table-bordered table-striped">
			<thead>
				<th colspan="9" class="text-center">Listado de notas</th>
			</thead>
			...
			<td>
				<button class="green" id="editn" type="submit" value="<?php echo $row['nota']; ?>"><i class="fa fa-pen"></i></button>				
