...
if (isset($_GET['page_no']) && $_GET['page_no']!="") {
	...
	$result_count = mysqli_query($bd,"SELECT COUNT(*) As total_records FROM `estudiante`");
...
/*------------------------------------------------------------------------------------------------*/
	...
	$query = "select * from estudiante limit $offset, $total_records_per_page";
...
<!----------------------------------------------------------------------------------------------->
	...
	<?php if($res->num_rows) : ?>
		...
		<div class="container content-section top2">
			...
			<div class="col-md-12 order-md-1">
				...
				<div class="text-center">
					<button form="button" class="blue"><i class="" ss="fa fa-search"></i> Buscar</button>

					<button id="form3" class="green"><i class="fa fa-paper-plane"></i> Formulario</button>
				</div>
		...
		<table class="table table-bordered table-striped">
			<thead>
				<th colspan="10" class="text-center">Listado de Estudiantes</th>
			</thead>
			...
			<td>
          <a class="btn blue" target="_blank" href="const_estudio.php?ci=<?php echo $row['ci'] ?>">
            <i class="material-icons">library_books</i>
          </a>
        </td>

			<td>
				<button class="green" id="edite" type="submit" value="<?php echo $row['id']; ?>"><i class="fa fa-pen"></i></button>			
